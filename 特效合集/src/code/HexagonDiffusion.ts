...
const HexagonDiffusion = () => {
  ...
  class Effect {
    ...
    add(position: any, color: any, maxRadius: any, duration: any, isEdit = false) {
      const _this = this;
  ...
  HexagonSpreadMaterialProperty.prototype.getValue = function (time: any, result: any) {
  ...
  HexagonSpreadMaterialProperty.prototype.equals = function (other: any) {
