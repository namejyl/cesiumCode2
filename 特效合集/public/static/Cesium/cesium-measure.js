            ...
            */
            transformWGS84ArrayToCartesianArray: function (WSG84Arr, alt) {
                if (this._viewer && WSG84Arr) {
                    var _this = this
                    return WSG84Arr
                        ? WSG84Arr.map(function (item) { return _this.transformWGS84ToCartesian(item, alt) })
                        : []
                }
            },
            /***
            ...
            */
            transformCartesianArrayToWGS84Array: function (cartesianArr) {
                if (this._viewer) {
                    var _this = this
                    return cartesianArr
                        ? cartesianArr.map(function (item) { return _this.transformCartesianToWGS84(item) })
                        : []
                }
            },
            /**
            ...
            */
            ...
            drawLineMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    var positions = [], _lineEntity = new Cesium.Entity(), _this = this, lineObj,
                    ...
                    function _addInfoPoint(position) {
                        ...
                        _labelEntity.label = {
                            text: (_this.getPositionDistance(_this.transformCartesianArrayToWGS84Array(positions)) / 1000).toFixed(4) + '公里',
                            show: true,
                            showBackground: true,
                            font: '14px monospace',
            ...
            drawAreaMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    var positions = [], polygon = new Cesium.PolygonHierarchy(), _polygonEntity = new Cesium.Entity(), _this = this, polyObj = null, _label = '',
                    ...
                    _handler.setInputAction(function (movement) {
                        ...
                        var cartesian = _this.getCatesian3FromPX(movement.endPosition);
                        // var cartesian = _this._viewer.scene.camera.pickEllipsoid(movement.endPosition, _this._viewer.scene.globe.ellipsoid);
                        if (positions.length >= 2) {
                            if (cartesian && cartesian.x) {
                                positions.pop()
                                positions.push(cartesian);
                    ...
                    function create() {
                        ...
                        polyObj = _this._drawLayer.entities.add(_polygonEntity)
                    }
                    ...
                    function _addInfoPoint(position) {
                        ...
                        _labelEntity.label = {
                            text: (_this.getPositionsArea(_this.transformCartesianArrayToWGS84Array(positions)) / 1000000.0).toFixed(4) + '平方公里',
                            show: true,
                            showBackground: true,
                            font: '14px monospace',
                            horizontalOrigin: Cesium.HorizontalOrigin.LEFT,
            ...
            drawTrianglesMeasureGraphics: function (options = {}) {
                ...
                if (this._viewer && options) {
                    ...
                    var _trianglesEntity = new Cesium.Entity(), _tempLineEntity = new Cesium.Entity(), _tempLineEntity2 = new Cesium.Entity(),
                        _positions = [], _tempPoints = [], _tempPoints2 = [], _this = this,
                        _handler = new Cesium.ScreenSpaceEventHandler(this._viewer.scene.canvas);
                    // 高度
                    ...
                    _trianglesEntity.label = {
                        text: new Cesium.CallbackProperty(function () {
                            return '直线:' + _this.getPositionDistance(_this.transformCartesianArrayToWGS84Array(_positions)) + '米'
                        }, false),
                        show: true,
                        showBackground: true,
                        font: '14px monospace',
                    ...
                    _tempLineEntity2.label = {
                        text: new Cesium.CallbackProperty(function () {
                            return '水平距离:' + _this.getPositionDistance(_this.transformCartesianArrayToWGS84Array(_tempPoints2)) + '米'
                        }, false),
                        show: true,
                        showBackground: true,
                        font: '14px monospace',
