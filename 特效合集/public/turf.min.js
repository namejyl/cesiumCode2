!(function (t, e) {
  ...
  var e = 6371008.8,
    ...
    r = { centimeters: 100, centimetres: 100, degrees: 1 / 111325, feet: 3.28084, inches: 39.37, kilometers: 0.001, kilometres: 0.001, meters: 1, metres: 1, miles: 1 / 1609.344, millimeters: 1e3, millimetres: 1e3, nauticalmiles: 1 / 1852, radians: 1 / e, yards: 1.0936133 },
    i = { acres: 247105e-9, centimeters: 1e4, centimetres: 1e4, feet: 10.763910417, hectares: 1e-4, inches: 1550.003100006, kilometers: 1e-6, kilometres: 1e-6, meters: 1, metres: 1, miles: 386e-9, millimeters: 1e6, millimetres: 1e6, yards: 1.195990046 };
  function o(t, e, n) {
    void 0 === n && (n = {});
    var r = { type: 'Feature' };
  ...
  function q(t, e) {
    ...
    for (n = 0; n < d; n++) {
      for (
        a = f ? t.features[n].geometry : g ? t.geometry : t, l = f ? t.features[n].properties : g ? t.properties : {}, c = f ? t.features[n].bbox : g ? t.bbox : void 0, h = f ? t.features[n].id : g ? t.id : void 0, s = (u = !!a && 'GeometryCollection' === a.type) ? a.geometries.length : 1, i = 0;
        i < s;
        i++
      )
  ...
  Z.default = Z;
  var ot = Object.freeze({ __proto__: null, getCoord: K, getCoords: Q, containsNumber: $, geojsonType: tt, featureOf: et, collectionOf: nt, getGeom: rt, getType: it }),
                    ...
                    (f = c[p]),
                      ...
                      (5 !== p && 10 !== p) ||
                        (5 === p
                          ...
                          : 10 === p && (h.flipped ? (-1 === a[v] ? ((f = 'top'), (r = 0), (i = 1)) : ((f = 'bottom'), (r = 0), (i = -1))) : 1 === u[v] && ((f = 'left'), (r = -1), (i = 0)))),
                      (g = vt(h, f)),
                      s.push([d + g[0], y + g[1]]),
                      yt(h),
                      (d += r),
              ...
              if (0 !== a && 15 !== a)
                (p = f = g = d = 0.5),
                  1 === a
                    ...
                    : 5 === a
                    ? ((p = gt(e, u, l)), (d = gt(e, c, l)), (f = 1 - gt(e, c, h)), (g = 1 - gt(e, u, h)))
                    : 6 === a
                    ...
                    : 10 === a
                    ? ((p = 1 - gt(e, l, u)), (d = 1 - gt(e, l, c)), (f = gt(e, h, c)), (g = gt(e, h, u)))
                    : 11 === a
    ...
    _chooseSubtree: function (t, e, n, r) {
      for (var i, o, s, a, u, l, c, h, p, f; r.push(e), !e.leaf && r.length - 1 !== n; ) {
        for (c = h = 1 / 0, i = 0, o = e.children.length; i < o; i++)
          (u = At((s = e.children[i]))), (p = t), (f = s), (l = (Math.max(f.maxX, p.maxX) - Math.min(f.minX, p.minX)) * (Math.max(f.maxY, p.maxY) - Math.min(f.minY, p.minY)) - u) < h ? ((h = l), (c = u < c ? u : c), (a = s)) : l === h && u < c && ((c = u), (a = s));
        e = a || e.children[0];
      }
      return e;
    },
  ...
  function le(t, e, n) {
    for (var r, i, o, s, a = Math.min(t[0], e[0]), u = Math.min(t[1], e[1]), l = Math.max(t[0], e[0]), c = Math.max(t[1], e[1]), h = n.search({ minX: a, minY: u, maxX: l, maxY: c }), p = 0; p < h.length; p++)
  ...
  function ge(t, e, n, r, i, o, s, a) {
    var u,
      ...
      I = w,
      N = w;
    0 === w ? ((l = 0), (I = 1), (h = b), (N = x)) : ((h = _ * b - m * E), (l = m * b - x * E) < 0 ? ((l = 0), (h = b), (N = x)) : l > I && ((l = I), (h = b + m), (N = x))),
      h < 0 ? ((h = 0), -E < 0 ? (l = 0) : -E > _ ? (l = I) : ((l = -E), (I = _))) : h > N && ((h = N), -E + m < 0 ? (l = 0) : -E + m > _ ? (l = I) : ((l = -E + m), (I = _)));
    ...
    return f(
      (function (t) {
        ...
        var f,
          ...
          v = 0.5 * (l + u),
          _ = 0.5 * (h + c),
          m = [new Ee({ __sentinel: !0, x: v - 20 * y, y: _ - y }, { __sentinel: !0, x: v, y: _ + 20 * y }, { __sentinel: !0, x: v + 20 * y, y: _ - y })],
          x = [],
          E = [];
        a = t.length;
        for (; a--; ) {
        ...
        var e = [t.a.x, t.a.y],
          ...
          i = [t.c.x, t.c.y],
          o = {};
        return n ? (e.push(t.a.z), r.push(t.b.z), i.push(t.c.z)) : (o = { a: t.a.z, b: t.b.z, c: t.c.z }), l([[e, r, i, e]], o);
      })
    );
  }
  ne.default = re;
  ...
  function We(t) {
    ...
    var e = 'GeometryCollection' === t.type ? { type: 'GeometryCollection', geometries: t.geometries.map(We) } : 'Point' === t.type || 'MultiPoint' === t.type ? { type: t.type, coordinates: t.coordinates } : { type: t.type, arcs: t.coordinates };
    return null != t.bbox && (e.bbox = t.bbox), e;
  }
  function Je(t, e) {
    var n = (function (t) {
      ...
      i = (function (t) {
        ...
        (function (t) {
          var e,
            ...
            s = t.lines,
            a = t.rings;
          for (n = 0, r = s.length; n < r; ++n) for (var u = s[n], l = u[0], c = u[1]; ++l < c; ) i.has(o[l]) && ((e = { 0: l, 1: u[1] }), (u[1] = l), (u = u.next = e));
          for (n = 0, r = a.length; n < r; ++n) for (var h = a[n], p = h[0], f = p, g = h[1], d = i.has(o[p]); ++f < g; ) i.has(o[f]) && (d ? ((e = { 0: f, 1: h[1] }), (h[1] = f), (h = h.next = e)) : (Ue(o, p, g, g - f), (o[g] = o[p]), (d = !0), (f = p)));
          return t;
        })(
          (function (t) {
            var e = -1,
  ...
  function tn(t, e) {
    ...
    return t.coordinates ? (!0 === n ? ((t.coordinates = i), t) : { type: r, coordinates: i }) : !0 === n ? ((t.geometry.coordinates = i), t) : o({ type: r, coordinates: i }, t.properties, { bbox: t.bbox, id: t.id });
  }
  function en(t) {
    var e = Q(t);
  ...
  var pn = (function () {
    function t(t) {
      ...
      for (e = 0; e < this.centers.length - 1; e++) {
        ...
        this.controls.push([
          { x: (1 - this.sharpness) * this.points[e + 1].x + this.sharpness * (this.centers[e].x + i), y: (1 - this.sharpness) * this.points[e + 1].y + this.sharpness * (this.centers[e].y + o), z: (1 - this.sharpness) * this.points[e + 1].z + this.sharpness * (this.centers[e].z + s) },
          { x: (1 - this.sharpness) * this.points[e + 1].x + this.sharpness * (this.centers[e + 1].x + i), y: (1 - this.sharpness) * this.points[e + 1].y + this.sharpness * (this.centers[e + 1].y + o), z: (1 - this.sharpness) * this.points[e + 1].z + this.sharpness * (this.centers[e + 1].z + s) }
        ]);
      }
    ...
    return (
      ...
      (t.prototype.pos = function (t) {
        ...
        return (function (t, e, n, r, i) {
          ...
          return { x: i.x * o[0] + r.x * o[1] + n.x * o[2] + e.x * o[3], y: i.y * o[0] + r.y * o[1] + n.y * o[2] + e.y * o[3], z: i.z * o[0] + r.z * o[1] + n.z * o[2] + e.z * o[3] };
  ...
  var Kn = Bt(function (t, e) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      ...
      (e.areaFactors = { acres: 247105e-9, centimeters: 1e4, centimetres: 1e4, feet: 10.763910417, hectares: 1e-4, inches: 1550.003100006, kilometers: 1e-6, kilometres: 1e-6, meters: 1, metres: 1, miles: 386e-9, millimeters: 1e6, millimetres: 1e6, yards: 1.195990046 }),
      (e.feature = n),
  ...
  var or = function (t) {
    ...
    br = Object.defineProperty(
      { coordAll: or, coordEach: sr, coordReduce: ar, featureEach: ur, featureReduce: lr, findPoint: cr, findSegment: hr, flattenEach: pr, flattenReduce: fr, geomEach: gr, geomReduce: dr, lineEach: yr, lineReduce: vr, propEach: _r, propReduce: mr, segmentEach: xr, segmentReduce: Er },
      '__esModule',
      { value: !0 }
    );
  function wr(t) {
      ...
      z(t, function (t) {
        for (var o = Q(t), s = 0; s < o.length - 1; s++) {
          ...
          var c = me(u, l, n),
            ...
            v = null;
          y.features.length > 0 && (((v = y.features[0]).properties.dist = me(e, v, n)), (v.properties.location = i + me(u, v, n))),
            u.properties.dist < r.properties.dist && (((r = u).properties.index = s), (r.properties.location = i)),
            l.properties.dist < r.properties.dist && (((r = l).properties.index = s + 1), (r.properties.location = i + c)),
  ...
  function Gr(t, e, n, r, i, o, s, a) {
    ...
    return 0 === (u = (a - o) * (n - t) - (s - i) * (r - e))
      ? null !== p.x && null !== p.y && p
      : ((h = (n - t) * (l = e - o) - (r - e) * (c = t - i)), (l = ((s - i) * l - (a - o) * c) / u), (c = h / u), (p.x = t + l * (n - t)), (p.y = e + l * (r - e)), l >= 0 && l <= 1 && (p.onLine1 = !0), c >= 0 && c <= 1 && (p.onLine2 = !0), !(!p.onLine1 || !p.onLine2) && [p.x, p.y]);
  }
  function qr(t) {
    for (
      var e = (function (t) {
      ...
      } else if ('LineString' === u.type) for (s = 0; !l && s < u.coordinates.length - 1; ) Br(n.geometry.coordinates[0], n.geometry.coordinates[1], u.coordinates[s][0], u.coordinates[s][1], u.coordinates[s + 1][0], u.coordinates[s + 1][1]) && ((l = !0), (r = !0)), s++;
    ...
    return r
      ? 'start' === r
        ...
        ? Math.abs(h) >= Math.abs(p)
          ...
          ? u <= s && s < c
          : c < s && s <= u
        : 'both' === r && (Math.abs(h) >= Math.abs(p) ? (h > 0 ? a < o && o < l : l < o && o < a) : p > 0 ? u < s && s < c : c < s && s < u)
      : Math.abs(h) >= Math.abs(p)
      ? h > 0
        ? a <= o && o <= l
        : l <= o && o <= a
  ...
  function oi(t) {
    ...
    if (0 == a) {
      var u = [];
      for (r = 0; r < e; r++) u.push(l([t.geometry.coordinates[r]], { parent: -1, winding: li(t.geometry.coordinates[r]) }));
      var c = f(u);
      return G(), q(), c;
    }
    var h = [],
    ...
    var y = [];
    for (r = 0; r < d; r++) y.push({ minX: p[r].coord[0], minY: p[r].coord[1], maxX: p[r].coord[0], maxY: p[r].coord[1], index: r });
    var v = Nt();
    v.load(y);
    for (r = 0; r < h.length; r++)
      for (g = 0; g < h[r].length; g++)
        ...
        t &&
          (F(s.search(t), function (n) {
            if (!1 === e) {
              var o = Q(t).sort(),
                s = Q(n).sort();
              Fi(o, s) || (0 === i ? Wr(o[0], n) && Wr(o[1], n) : Tr(n, o[0]).properties.dist <= i && Tr(n, o[1]).properties.dist <= i)
                ? ((e = !0), (r = r ? Gi(r, t) : t))
                : (0 === i ? Wr(s[0], t) && Wr(s[1], t) : Tr(t, s[0]).properties.dist <= i && Tr(t, s[1]).properties.dist <= i) && (r = r ? Gi(r, n) : n);
            }
          }),
  ...
  function $i(t, e, n, r) {
    ...
    var u,
      l = (function (t, e, n) {
        for (var r = t.length - 1, i = t[0].length - 1, o = { rows: r, cols: i, cells: [] }, s = e + Math.abs(n), a = 0; a < r; ++a) {
          o.cells[a] = [];
          for (var u = 0; u < i; ++u) {
            var l = 0,
              c = t[a + 1][u],
            ...
            if (!(isNaN(c) || isNaN(h) || isNaN(p) || isNaN(f))) {
              ...
              if (0 != l && 170 != l) {
                ...
                1 === l
                  ...
                  : 168 === l
                  ? ((x = Vo(s, f, p)), (m = Vo(e, f, p)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), N.push(ko[l]), N.push(Go[l]))
                  : 2 === l
                  ? ((x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), N.push(ko[l]), N.push(Go[l]))
                  : 162 === l
                  ? ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), N.push(ko[l]), N.push(Go[l]))
                  : 8 === l
                  ? ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (x = Vo(s, f, p)), (m = Vo(e, f, p)), N.push(Do[l]), N.push(Fo[l]))
                  : 138 === l
                  ? ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c)), N.push(Do[l]), N.push(Fo[l]))
                  : 32 === l
                  ? ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (v = Vo(e, c, h)), (_ = Vo(s, c, h)), N.push(Do[l]), N.push(Fo[l]))
                  : 42 === l
                  ? ((I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), (v = Vo(e, c, h)), (_ = Vo(s, c, h)), N.push(qo[l]), N.push(Bo[l]))
                  : 128 === l && ((I = Vo(e, f, c)), (w = Vo(s, f, c)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c)), N.push(qo[l]), N.push(Bo[l])),
                  5 === l
                    ...
                    : 160 === l
                    ? ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), N.push(Do[l]), N.push(Fo[l]))
                    : 10 === l
                    ? ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), N.push(Do[l]), N.push(Fo[l]))
                    : 130 === l
                    ? ((x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c)), N.push(ko[l]), N.push(Go[l]))
                    : 40 === l
                    ? ((x = Vo(s, f, p)), (m = Vo(e, f, p)), (v = Vo(e, c, h)), (_ = Vo(s, c, h)), N.push(ko[l]), N.push(Go[l]))
                    : 101 === l
                    ...
                    : 96 === l
                    ? ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (w = Vo(e, f, c)), (v = Vo(s, c, h)), N.push(Do[l]), N.push(Fo[l]))
                    : 74 === l
                    ? ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (w = 1 - Vo(s, c, f)), (v = 1 - Vo(e, h, c)), N.push(Do[l]), N.push(Fo[l]))
                    : 24 === l
                    ? ((E = 1 - Vo(s, h, p)), (x = Vo(s, f, p)), (m = Vo(e, f, p)), (_ = Vo(e, c, h)), N.push(Do[l]), N.push(Go[l]))
                    : 146 === l
                    ? ((E = Vo(e, p, h)), (x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (_ = 1 - Vo(s, h, c)), N.push(Do[l]), N.push(Go[l]))
                    : 6 === l
                    ? ((b = 1 - Vo(e, h, p)), (x = 1 - Vo(s, p, f)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), N.push(Fo[l]), N.push(ko[l]))
                    : 164 === l
                    ? ((b = Vo(s, p, h)), (x = Vo(e, f, p)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), N.push(Fo[l]), N.push(ko[l]))
                    : 129 === l
                    ? ((m = 1 - Vo(e, p, f)), (I = Vo(s, f, c)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c)), N.push(Go[l]), N.push(qo[l]))
                    : 41 === l
                    ? ((m = Vo(s, f, p)), (I = 1 - Vo(e, c, f)), (v = Vo(e, c, h)), (_ = Vo(s, c, h)), N.push(Go[l]), N.push(qo[l]))
                    : 66 === l
                    ? ((x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (w = 1 - Vo(s, c, f)), (v = 1 - Vo(e, h, c)), N.push(ko[l]), N.push(Go[l]))
                    : 104 === l
                    ? ((x = Vo(s, f, p)), (m = Vo(e, f, p)), (w = Vo(e, f, c)), (v = Vo(s, c, h)), N.push(Go[l]), N.push(zo[l]))
                    : 144 === l
                    ? ((E = Vo(e, p, h)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), (_ = 1 - Vo(s, h, c)), N.push(Do[l]), N.push(Bo[l]))
                    : 26 === l
                    ? ((E = 1 - Vo(s, h, p)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), (_ = Vo(e, c, h)), N.push(Do[l]), N.push(Bo[l]))
                    : 36 === l
                    ? ((b = Vo(s, p, h)), (x = Vo(e, f, p)), (v = Vo(e, c, h)), (_ = Vo(s, c, h)), N.push(Fo[l]), N.push(ko[l]))
                    : 134 === l
                    ? ((b = 1 - Vo(e, h, p)), (x = 1 - Vo(s, p, f)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c)), N.push(Fo[l]), N.push(ko[l]))
                    : 9 === l
                    ? ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (m = Vo(s, f, p)), (I = 1 - Vo(e, c, f)), N.push(Do[l]), N.push(Fo[l]))
                    : 161 === l
                    ? ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (m = 1 - Vo(e, p, f)), (I = Vo(s, f, c)), N.push(Do[l]), N.push(Fo[l]))
                    : 37 === l
                    ? ((b = Vo(s, p, h)), (I = 1 - Vo(e, c, f)), (v = Vo(e, c, h)), (_ = Vo(s, c, h)), N.push(Fo[l]), N.push(qo[l]))
                    : 133 === l
                    ? ((b = 1 - Vo(e, h, p)), (I = Vo(s, f, c)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c)), N.push(Fo[l]), N.push(qo[l]))
                    : 148 === l
                    ? ((x = Vo(e, f, p)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), (_ = 1 - Vo(s, h, c)), N.push(ko[l]), N.push(Bo[l]))
                    : 22 === l
                    ? ((x = 1 - Vo(s, p, f)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), (_ = Vo(e, c, h)), N.push(ko[l]), N.push(Bo[l]))
                    : 82 === l
                    ? ((E = Vo(e, p, h)), (x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (w = 1 - Vo(s, c, f)), N.push(Do[l]), N.push(Go[l]))
                    : 88 === l
                    ? ((E = 1 - Vo(s, h, p)), (x = Vo(s, f, p)), (m = Vo(e, f, p)), (w = Vo(e, f, c)), N.push(Do[l]), N.push(Go[l]))
                    : 73 === l
                    ? ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (m = Vo(s, f, p)), (v = 1 - Vo(e, h, c)), N.push(Do[l]), N.push(Fo[l]))
                    : 97 === l
                    ? ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (m = 1 - Vo(e, p, f)), (v = Vo(s, c, h)), N.push(Do[l]), N.push(Fo[l]))
                    : 145 === l
                    ? ((E = Vo(e, p, h)), (m = 1 - Vo(e, p, f)), (I = Vo(s, f, c)), (_ = 1 - Vo(s, h, c)), N.push(Do[l]), N.push(qo[l]))
                    : 25 === l
                    ? ((E = 1 - Vo(s, h, p)), (m = Vo(s, f, p)), (I = 1 - Vo(e, c, f)), (_ = Vo(e, c, h)), N.push(Do[l]), N.push(qo[l]))
                    : 70 === l
                    ? ((b = 1 - Vo(e, h, p)), (x = 1 - Vo(s, p, f)), (w = 1 - Vo(s, c, f)), (v = 1 - Vo(e, h, c)), N.push(Fo[l]), N.push(ko[l]))
                    : 100 === l
                    ? ((b = Vo(s, p, h)), (x = Vo(e, f, p)), (w = Vo(e, f, c)), (v = Vo(s, c, h)), N.push(Fo[l]), N.push(ko[l]))
                    : 34 === l
                    ? (0 === d
                        ? ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (x = Vo(s, f, p)), (m = Vo(e, f, p)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c)))
                        : ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), (v = Vo(e, c, h)), (_ = Vo(s, c, h))),
                      N.push(Do[l]),
                      N.push(Fo[l]),
                      N.push(qo[l]),
                      N.push(Bo[l]))
                    ...
                    ? (0 === d
                      ...
                      N.push(Bo[l]))
                    : 153 === l
                    ? (0 === d ? ((E = Vo(e, p, h)), (m = 1 - Vo(e, p, f)), (I = 1 - Vo(e, c, f)), (_ = Vo(e, c, h))) : ((E = 1 - Vo(s, h, p)), (m = Vo(s, f, p)), (I = Vo(s, f, c)), (_ = 1 - Vo(s, h, c))), N.push(Do[l]), N.push(Go[l]))
                    : 102 === l
                    ? (0 === d ? ((b = 1 - Vo(e, h, p)), (x = Vo(e, f, p)), (w = Vo(e, f, c)), (v = 1 - Vo(e, h, c))) : ((b = Vo(s, p, h)), (x = 1 - Vo(s, p, f)), (w = 1 - Vo(s, c, f)), (v = Vo(s, c, h))), N.push(Fo[l]), N.push(Bo[l]))
                    : 155 === l
                    ? (4 === d ? ((E = Vo(e, p, h)), (m = 1 - Vo(e, p, f)), (I = 1 - Vo(e, c, f)), (_ = Vo(e, c, h))) : ((E = 1 - Vo(s, h, p)), (m = Vo(s, f, p)), (I = Vo(s, f, c)), (_ = 1 - Vo(s, h, c))), N.push(Do[l]), N.push(qo[l]))
                    : 103 === l
                    ? (4 === d ? ((b = 1 - Vo(e, h, p)), (x = Vo(e, f, p)), (w = Vo(e, f, c)), (v = 1 - Vo(e, h, c))) : ((b = Vo(s, p, h)), (x = 1 - Vo(s, p, f)), (w = 1 - Vo(s, c, f)), (v = Vo(s, c, h))), N.push(Fo[l]), N.push(ko[l]))
                    : 152 === l
                    ? (0 === d ? ((E = Vo(e, p, h)), (x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), (_ = Vo(e, c, h))) : ((E = 1 - Vo(s, h, p)), (x = Vo(s, f, p)), (m = Vo(e, f, p)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), (_ = 1 - Vo(s, h, c))),
                      N.push(Do[l]),
                      N.push(ko[l]),
                      N.push(Go[l]))
                    : 156 === l
                    ? (4 === d ? ((E = Vo(e, p, h)), (x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), (_ = Vo(e, c, h))) : ((E = 1 - Vo(s, h, p)), (x = Vo(s, f, p)), (m = Vo(e, f, p)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), (_ = 1 - Vo(s, h, c))),
                      N.push(Do[l]),
                      N.push(Go[l]),
                      N.push(Bo[l]))
                    : 137 === l
                    ? (0 === d ? ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (m = 1 - Vo(e, p, f)), (I = 1 - Vo(e, c, f)), (v = Vo(e, c, h)), (_ = Vo(s, c, h))) : ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (m = Vo(s, f, p)), (I = Vo(s, f, c)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c))),
                      N.push(Do[l]),
                      N.push(Fo[l]),
                      N.push(Go[l]))
                    : 139 === l
                    ? (4 === d ? ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (m = 1 - Vo(e, p, f)), (I = 1 - Vo(e, c, f)), (v = Vo(e, c, h)), (_ = Vo(s, c, h))) : ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (m = Vo(s, f, p)), (I = Vo(s, f, c)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c))),
                      N.push(Do[l]),
                      N.push(Fo[l]),
                      N.push(qo[l]))
                    : 98 === l
                    ? (0 === d ? ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (x = Vo(s, f, p)), (m = Vo(e, f, p)), (w = Vo(e, f, c)), (v = 1 - Vo(e, h, c))) : ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (w = 1 - Vo(s, c, f)), (v = Vo(s, c, h))),
                      N.push(Do[l]),
                      N.push(Fo[l]),
                      N.push(Bo[l]))
                    : 99 === l
                    ? (4 === d ? ((E = 1 - Vo(e, h, p)), (b = 1 - Vo(s, h, p)), (x = Vo(s, f, p)), (m = Vo(e, f, p)), (w = Vo(e, f, c)), (v = 1 - Vo(e, h, c))) : ((E = Vo(s, p, h)), (b = Vo(e, p, h)), (x = 1 - Vo(e, p, f)), (m = 1 - Vo(s, p, f)), (w = 1 - Vo(s, c, f)), (v = Vo(s, c, h))),
                      N.push(Do[l]),
                      N.push(Fo[l]),
                      N.push(Go[l]))
                    : 38 === l
                    ? (0 === d ? ((b = 1 - Vo(e, h, p)), (x = Vo(e, f, p)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c))) : ((b = Vo(s, p, h)), (x = 1 - Vo(s, p, f)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), (v = Vo(e, c, h)), (_ = Vo(s, c, h))),
                      N.push(Fo[l]),
                      N.push(qo[l]),
                      N.push(Bo[l]))
                    : 39 === l
                    ? (4 === d ? ((b = 1 - Vo(e, h, p)), (x = Vo(e, f, p)), (I = Vo(e, f, c)), (w = Vo(s, f, c)), (v = 1 - Vo(s, h, c)), (_ = 1 - Vo(e, h, c))) : ((b = Vo(s, p, h)), (x = 1 - Vo(s, p, f)), (I = 1 - Vo(s, c, f)), (w = 1 - Vo(e, c, f)), (v = Vo(e, c, h)), (_ = Vo(s, c, h))),
                      N.push(Fo[l]),
                      N.push(ko[l]),
                      N.push(Bo[l]))
                    : 85 === l && ((E = 1), (b = 0), (x = 1), (m = 0), (I = 0), (w = 1), (v = 0), (_ = 1)),
                  (v < 0 || v > 1 || _ < 0 || _ > 1 || E < 0 || E > 1 || x < 0 || x > 1 || I < 0 || I > 1 || w < 0 || w > 1) &&
                    console.log('MarchingSquaresJS-isoBands: ' + l + ' ' + g + ' ' + c + ',' + h + ',' + p + ',' + f + ' ' + d + ' ' + v + ' ' + _ + ' ' + E + ' ' + b + ' ' + x + ' ' + m + ' ' + I + ' ' + w),
                  (o.cells[a][u] = { cval: l, cval_real: g, flipped: d, topleft: v, topright: _, righttop: E, rightbottom: b, bottomright: x, bottomleft: m, leftbottom: I, lefttop: w, edges: N });
              }
            }
          }
        }
    ...
    return (
      Qi.polygons
        ? (Qi.verbose && console.log('MarchingSquaresJS-isoBands: returning single polygons for each grid cell'),
          (u = (function (t) {
            var e = [],
              n = 0;
            return (
        ...
        : (Qi.verbose && console.log('MarchingSquaresJS-isoBands: returning polygon paths for entire data grid'),
          (u = (function (t) {
  ...
  function Wo(t, e, n, r) {
    ...
    return (void 0 !== e && void 0 !== n && void 0 !== s && void 0 !== a && void 0 !== u) || (console.log('MarchingSquaresJS-isoBands: undefined value!'), console.log(t), console.log(e + ' ' + n + ' ' + s + ' ' + a + ' ' + u)), { p: [e, n], x: s, y: a, o: u };
  }
  function Jo(t) {
    var e = [],
      n = [];
          ...
          return (
            e.forEach(function (e) {
              ...
              if (
                ...
                Math.max.apply(null, u) !== Math.max.apply(null, c) || Math.max.apply(null, l) !== Math.max.apply(null, h) || Math.min.apply(null, u) !== Math.min.apply(null, c) || Math.min.apply(null, l) !== Math.min.apply(null, h)) &&
                as(p, i)
              ) {
                for (
  ...
  function Aa(t, e, n, r) {
    ...
    else (e = ji(t, e, 90, { units: o })), (n = ji(t, n, 0, { units: o })), (e = K(e)[0] - c[0]), (n = K(n)[1] - c[1]);
    ...
    R(
      ...
      function (i, o, s, a, u) {
        ...
        var l = o - r,
          ...
          f = c[0],
          g = c[1];
        e[u].push([0.75 * h + 0.25 * f, 0.75 * p + 0.25 * g]), e[u].push([0.25 * h + 0.75 * f, 0.25 * p + 0.75 * g]);
      },
      !0
    ),
      e.forEach(function (t) {
    ...
    R(
      ...
      function (o, s, a, u, l) {
        ...
        var c = s - r,
          ...
          g = h[0],
          d = h[1];
        e[u][l].push([0.75 * p + 0.25 * g, 0.75 * f + 0.25 * d]), e[u][l].push([0.25 * p + 0.75 * g, 0.25 * f + 0.75 * d]);
      },
      !0
    ),
      e.forEach(function (t) {
        ...
        this.cells.forEach(function (n, r) {
          if ((o = (i = n.halfedges).length))
            for (var i, o, s, a, u, l, c = n.site, h = -1, p = e[i[o - 1]], f = p.left === c ? p.right : p.left; ++h < o; )
              (s = f), (f = (p = e[i[h]]).left === c ? p.right : p.left), s && f && r < s.index && r < f.index && ((u = s), (l = f), ((a = c)[0] - l[0]) * (u[1] - a[1]) - (a[0] - u[0]) * (l[1] - a[1]) < 0) && t.push([c.data, s.data, f.data]);
        }),
        t
      );
    },
  ...
  function tu(t, e) {
    ...
    for (var s = [], a = 0; a < t; a++) {
      for (var u = [Ka(n)], l = 0; l < r - 1; l++) {
        var c = (0 === l ? 2 * Math.random() * Math.PI : Math.tan((u[l][1] - u[l - 1][1]) / (u[l][0] - u[l - 1][0]))) + (Math.random() - 0.5) * o * 2,
          p = Math.random() * i;
  ...
  var ru = Object.freeze({ __proto__: null, randomPosition: Ka, randomPoint: Qa, randomPolygon: $a, randomLineString: tu });
  function iu(t, e) {
    if (!t) throw new Error('geojson is required');
  ...
  var hu = Object.freeze({ __proto__: null, getCluster: iu, clusterEach: ou, clusterReduce: su, createBins: au, applyFilter: uu, propertiesContainsFilter: lu, filterProperties: cu }),
    pu = function (t, e) {
  ...
  var _u = (function () {
    ...
    return (
      ...
      (t.prototype.pop = function () {
        ...
        if (t) {
          for (; t.left; ) t = t.left;
          return (this._root = gu(t.key, this._root, this._comparator)), (this._root = this._remove(t.key, this._root, this._comparator)), { key: t.key, data: t.data };
        }
        return null;
      }),
  ...
  var Pu = Cu * Cu,
              ...
              var e = this,
                ...
                r = function (r) {
                  var i,
                    ...
                    u,
                    l = r.otherSE;
                  n.set(r, { sine: ((i = e.point), (o = t.point), (s = l.point), (a = { x: o.x - i.x, y: o.y - i.y }), (u = { x: s.x - i.x, y: s.y - i.y }), Tu(u, a) / Fu(u) / Fu(a)), cosine: ku(e.point, t.point, l.point) });
                };
              return function (t, e) {
    ...
    Vu = (function () {
      function t(e, n) {
        ...
        (this.exteriorRing = new Uu(e[0], this, !0)), (this.bbox = { ll: { x: this.exteriorRing.bbox.ll.x, y: this.exteriorRing.bbox.ll.y }, ur: { x: this.exteriorRing.bbox.ur.x, y: this.exteriorRing.bbox.ur.y } }), (this.interiorRings = []);
        ...
        Iu(t, [
          {
            ...
            value: function (t, e, n) {
              ...
              for (var f = new _u(Bu.compare), g = 0, d = r.length; g < d; g++)
                for (var y = r[g].getSweepEvents(), v = 0, _ = y.length; v < _; v++) if ((f.insert(y[v]), f.size > Zu)) throw new Error('Infinite loop when putting segment endpoints in a priority queue (queue size too big). Please file a bug report.');
                ...
                if (f.size === x) {
                  ...
                  throw new Error(
                    'Unable to pop() '.concat(b.isLeft ? 'left' : 'right', ' SweepEvent ') +
                      '['.concat(b.point.x, ', ').concat(b.point.y, '] from segment #').concat(w.id, ' ') +
  ...
  var ul = function t() {
    ...
    ll = { DimensionalComparator: { configurable: !0 }, serialVersionUID: { configurable: !0 }, NULL_ORDINATE: { configurable: !0 }, X: { configurable: !0 }, Y: { configurable: !0 }, Z: { configurable: !0 } };
  ...
  var pl = function () {},
    fl = { INTERIOR: { configurable: !0 }, BOUNDARY: { configurable: !0 }, EXTERIOR: { configurable: !0 }, NONE: { configurable: !0 } };
    ...
    (Ll.prototype.expandToInclude = function () {
      if (1 === arguments.length) {
        if (arguments[0] instanceof ul) {
          ...
          this.isNull()
            ? ((this._minx = e.getMinX()), (this._maxx = e.getMaxX()), (this._miny = e.getMinY()), (this._maxy = e.getMaxY()))
            : (e._minx < this._minx && (this._minx = e._minx), e._maxx > this._maxx && (this._maxx = e._maxx), e._miny < this._miny && (this._miny = e._miny), e._maxy > this._maxy && (this._maxy = e._maxy));
        }
      } else if (2 === arguments.length) {
        var n = arguments[0],
          r = arguments[1];
  ...
  var Rl = { typeStr: /^\s*(\w+)\s*\(\s*(.*)\s*\)\s*$/, emptyTypeStr: /^\s*(\w+)\s*EMPTY\s*$/, spaces: /\s+/, parenComma: /\)\s*,\s*\(/, doubleParenComma: /\)\s*\)\s*,\s*\(\s*\(/, trimParens: /^\s*\(?(.*?)\)?\s*$/ },
    Tl = function (t) {
  ...
  var Bl = function () {
    ...
    zl = { DONT_INTERSECT: { configurable: !0 }, DO_INTERSECT: { configurable: !0 }, COLLINEAR: { configurable: !0 }, NO_INTERSECTION: { configurable: !0 }, POINT_INTERSECTION: { configurable: !0 }, COLLINEAR_INTERSECTION: { configurable: !0 } };
      ...
      return (
        ...
        (e.prototype.computeCollinearIntersection = function (e, n, r, i) {
          ...
          return o && s
            ...
            : o && a
            ? ((this._intPt[0] = r), (this._intPt[1] = e), !r.equals(e) || s || u ? t.COLLINEAR_INTERSECTION : t.POINT_INTERSECTION)
            : o && u
            ? ((this._intPt[0] = r), (this._intPt[1] = n), !r.equals(n) || s || a ? t.COLLINEAR_INTERSECTION : t.POINT_INTERSECTION)
            : s && a
            ? ((this._intPt[0] = i), (this._intPt[1] = e), !i.equals(e) || o || u ? t.COLLINEAR_INTERSECTION : t.POINT_INTERSECTION)
            : s && u
            ? ((this._intPt[0] = i), (this._intPt[1] = n), !i.equals(n) || o || a ? t.COLLINEAR_INTERSECTION : t.POINT_INTERSECTION)
            : t.NO_INTERSECTION;
        }),
        ...
        (e.prototype.computeIntersect = function (e, n, r, i) {
          ...
          return (a > 0 && u > 0) || (a < 0 && u < 0)
            ...
            : (0 === o || 0 === s || 0 === a || 0 === u
                ? ((this._isProper = !1),
                  e.equals2D(r) || e.equals2D(i) ? (this._intPt[0] = e) : n.equals2D(r) || n.equals2D(i) ? (this._intPt[0] = n) : 0 === o ? (this._intPt[0] = new ul(r)) : 0 === s ? (this._intPt[0] = new ul(i)) : 0 === a ? (this._intPt[0] = new ul(e)) : 0 === u && (this._intPt[0] = new ul(n)))
  ...
  var Xl = function () {},
    Yl = { CLOCKWISE: { configurable: !0 }, RIGHT: { configurable: !0 }, COUNTERCLOCKWISE: { configurable: !0 }, LEFT: { configurable: !0 }, COLLINEAR: { configurable: !0 }, STRAIGHT: { configurable: !0 } };
  (Xl.prototype.interfaces_ = function () {
    return [];
  }),
    (Xl.prototype.getClass = function () {
  ...
  var lc = (function (t) {
    ...
    pc = function () {},
    fc = { ForwardComparator: { configurable: !0 }, BidirectionalComparator: { configurable: !0 }, coordArrayType: { configurable: !0 } };
  ...
  var kc = (function (t) {
      ...
      return (
        ...
        (e.prototype.apply = function () {
          var t = this;
          if (gl(arguments[0], Kl)) for (var e = arguments[0], n = 0; n < this._geometries.length; n++) t._geometries[n].apply(e);
  ...
  var Zc = (function (t) {
      ...
      return (
        ...
        (e.prototype.apply = function () {
          var t = this;
          if (gl(arguments[0], Kl)) for (var e = arguments[0], n = 0; n < this._points.size(); n++) e.filter(t._points.getCoordinate(n));
          else if (gl(arguments[0], Fc)) {
            var r = arguments[0];
  ...
  var th = (function (t) {
    ...
    oh = { NoOpGeometryOperation: { configurable: !0 }, CoordinateOperation: { configurable: !0 }, CoordinateSequenceOperation: { configurable: !0 } };
  (ih.prototype.setCopyUserData = function (t) {
    ...
    (ih.prototype.editInternal = function (t, e) {
      return (
        ...
        t instanceof kc ? this.editGeometryCollection(t, e) : t instanceof th ? this.editPolygon(t, e) : t instanceof Qc || t instanceof Zc ? e.edit(t, this._factory) : (ql.shouldNeverReachHere('Unsupported Geometry class: ' + t.getClass().getName()), null)
      );
    }),
      ...
      (this._precisionModel = new gh()),
        ...
        0 === arguments.length ||
          (1 === arguments.length
            ...
            : 3 === arguments.length && ((this._precisionModel = arguments[0]), (this._SRID = arguments[1]), (this._coordinateSequenceFactory = arguments[2])));
    },
  ...
  (_h.prototype.toGeometry = function (t) {
    return t.isNull()
      ...
      : this.createPolygon(this.createLinearRing([new ul(t.getMinX(), t.getMinY()), new ul(t.getMinX(), t.getMaxY()), new ul(t.getMaxX(), t.getMaxY()), new ul(t.getMaxX(), t.getMinY()), new ul(t.getMinX(), t.getMinY())]), null);
  }),
  ...
  var ip = function t() {
    ...
    op = { IntersectsOp: { configurable: !0 }, serialVersionUID: { configurable: !0 }, DEFAULT_NODE_CAPACITY: { configurable: !0 } };
  ...
  var Pp = function (t) {
    ...
    Mp = { INIT: { configurable: !0 }, DELETE: { configurable: !0 }, KEEP: { configurable: !0 }, NUM_PTS_TO_CHECK: { configurable: !0 } };
  ...
  var Rp = function () {},
    Tp = { PI_TIMES_2: { configurable: !0 }, PI_OVER_2: { configurable: !0 }, PI_OVER_4: { configurable: !0 }, COUNTERCLOCKWISE: { configurable: !0 }, CLOCKWISE: { configurable: !0 }, NONE: { configurable: !0 } };
  (Rp.prototype.interfaces_ = function () {
    return [];
  }),
    (Rp.prototype.getClass = function () {
  ...
  var Ap = function t() {
    ...
    Dp = { OFFSET_SEGMENT_SEPARATION_FACTOR: { configurable: !0 }, INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR: { configurable: !0 }, CURVE_VERTEX_SNAP_DISTANCE_FACTOR: { configurable: !0 }, MAX_CLOSING_SEG_LEN_FACTOR: { configurable: !0 } };
  (Ap.prototype.addNextSegment = function (t, e) {
    ...
    (Ap.prototype.addOutsideTurn = function (t, e) {
      ...
      this._bufParams.getJoinStyle() === Sp.JOIN_MITRE
        ...
        : (e && this._segList.addPt(this._offset0.p1), this.addFilletCorner(this._s1, this._offset0.p1, this._offset1.p0, t, this._distance), this._segList.addPt(this._offset1.p0));
    }),
    ...
    (Ap.prototype.addCollinear = function (t) {
      this._li.computeIntersection(this._s0, this._s1, this._s1, this._s2),
        this._li.getIntersectionNum() >= 2 &&
          (this._bufParams.getJoinStyle() === Sp.JOIN_BEVEL || this._bufParams.getJoinStyle() === Sp.JOIN_MITRE ? (t && this._segList.addPt(this._offset0.p1), this._segList.addPt(this._offset1.p0)) : this.addFilletCorner(this._s1, this._offset0.p1, this._offset1.p0, Xl.CLOCKWISE, this._distance));
    }),
    ...
    (Kp.prototype.processIntersections = function (t, e, n, r) {
      ...
      this._li.computeIntersection(i, o, s, a),
        this._li.hasIntersection() &&
          ...
          this.isTrivialIntersection(t, e, n, r) || ((this._hasIntersection = !0), t.addIntersections(this._li, e, 0), n.addIntersections(this._li, r, 1), this._li.isProper() && (this.numProperIntersections++, (this._hasProper = !0), (this._hasProperInterior = !0))));
    }),
  ...
  (uf.prototype.checkEndPtVertexIntersections = function () {
    ...
    (uf.prototype.checkInteriorIntersections = function () {
      ...
      else if (2 === arguments.length) for (var o = arguments[0], s = arguments[1], a = o.getCoordinates(), u = s.getCoordinates(), l = 0; l < a.length - 1; l++) for (var c = 0; c < u.length - 1; c++) t.checkInteriorIntersections(o, l, s, c);
      else if (4 === arguments.length) {
        var h = arguments[0],
          p = arguments[1],
          f = arguments[2],
    ...
    (cf.prototype.intersectsPixelClosure = function (t, e) {
      return (
        ...
        !!this._li.hasIntersection() ||
          ...
          !!this._li.hasIntersection() || (this._li.computeIntersection(t, e, this._corner[2], this._corner[3]), !!this._li.hasIntersection() || (this._li.computeIntersection(t, e, this._corner[3], this._corner[0]), !!this._li.hasIntersection())))
      );
    }),
      ...
      return (
        ...
        !!this._li.isProper() ||
          ...
          !!this._li.isProper() ||
            ...
            !!this._li.isProper() || (this._li.hasIntersection() && (r = !0), this._li.computeIntersection(t, e, this._corner[3], this._corner[0]), !!this._li.isProper() || !(!n || !r) || !!t.equals(this._pt) || !!e.equals(this._pt))))
      );
    }),
  ...
  var _f = function () {
    ...
    mf = { CAP_ROUND: { configurable: !0 }, CAP_BUTT: { configurable: !0 }, CAP_FLAT: { configurable: !0 }, CAP_SQUARE: { configurable: !0 }, MAX_PRECISION_DIGITS: { configurable: !0 } };
  ...
  (Pf.prototype.locateInternal = function () {
    ...
    (Pf.prototype.locate = function (t, e) {
      return e.isEmpty()
        ...
        : ((this._isIn = !1), (this._numBoundaries = 0), this.computeLocation(t, e), this._boundaryRule.isInBoundary(this._numBoundaries) ? pl.BOUNDARY : this._numBoundaries > 0 || this._isIn ? pl.INTERIOR : pl.EXTERIOR);
    }),
    (Pf.prototype.interfaces_ = function () {
      return [];
    }),
      ...
      return (
        ...
        this._minDistance <= this._terminateDistance
          ...
          : ((t[0] = null),
            ...
            this._minDistance <= this._terminateDistance
              ? null
              : ((t[0] = null), (t[1] = null), this.computeMinDistanceLinesPoints(n, r, t), this.updateMinDistance(t, !0), this._minDistance <= this._terminateDistance ? null : ((t[0] = null), (t[1] = null), this.computeMinDistancePoints(r, i, t), void this.updateMinDistance(t, !1))))
      );
    }),
  ...
  (ng.prototype.getCommon = function () {
    ...
    (ng.prototype.add = function (t) {
      ...
      return this._isFirst
        ? ((this._commonBits = e), (this._commonSignExp = ng.signExpBits(this._commonBits)), (this._isFirst = !1), null)
        : ng.signExpBits(e) !== this._commonSignExp
        ? ((this._commonBits = 0), null)
        : ((this._commonMantissaBitsCount = ng.numCommonMostSigMantissaBits(this._commonBits, e)), void (this._commonBits = ng.zeroLowerBits(this._commonBits, 64 - (12 + this._commonMantissaBitsCount))));
    }),
      ...
      this._li.computeIntersection(i, o, s, a),
        this._li.hasIntersection() &&
          ...
          this.isTrivialIntersection(t, e, n, r) ||
            ...
            (!this._includeProper && this._li.isProper()) || (t.addIntersections(this._li, e, 0), n.addIntersections(this._li, r, 1)),
            this._li.isProper() && ((this._properIntersectionPoint = this._li.getIntersection(0).copy()), (this._hasProper = !0), this._isDoneWhenProperInt && (this._isDone = !0), this.isBoundaryPoint(this._li, this._bdyNodes) || (this._hasProperInterior = !0))));
    }),
          ...
          if (!r.isNull()) {
            ...
            for (var i = 0; i < 2; i++)
              n.isNull(i) ||
                ...
                (0 === r.getDelta(i)
                  ? n.toLine(i)
                  : (ql.isTrue(!r.isNull(i, Sh.LEFT), 'depth of LEFT side has not been initialized'), n.setLocation(i, Sh.LEFT, r.getLocation(i, Sh.LEFT)), ql.isTrue(!r.isNull(i, Sh.RIGHT), 'depth of RIGHT side has not been initialized'), n.setLocation(i, Sh.RIGHT, r.getLocation(i, Sh.RIGHT))));
          }
        }
      }),
      ...
      function w(o, s) {
        ...
        if ((l && c.push([o, s]), v)) (h = o), (p = s), (f = a), (v = !1), a && (m.lineStart(), m.point(o, s));
          ...
          !(function (t, e, n, r, i, o) {
            ...
            : (y || (m.lineStart(), m.point(u[0], u[1])), m.point(x[0], x[1]), a || m.lineEnd(), (_ = !1));
        }
        (g = o), (d = s), (y = a);
      }
      return E;
      ...
      return {
        ...
        point: function (o, s) {
          var a = o > 0 ? Vg : -Vg,
            u = Zg(o - n);
          Zg(u - Vg) < Ug
            ? (t.point(n, (r = (r + s) / 2 > 0 ? Xg : -Xg)), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), (e = 0))
            : i !== a &&
              u >= Vg &&
              (Zg(n - i) < Ug && (n -= i * Ug),
              Zg(o - a) < Ug && (o -= a * Ug),
          ...
          function n(r, i, o, s, a, u, l, c, h, p, f, g, d, y) {
            ...
            if (m > 4 * e && d--) {
              var x = s + p,
                ...
                L = P - i,
                O = _ * M - v * L;
              ((O * O) / m > e || Zg((v * M + _ * L) / m - 0.5) > 0.3 || s * p + a * f + u * g < Zd) && (n(r, i, o, s, a, u, C, P, N, (x /= w), (E /= w), b, d, y), y.point(C, P), n(C, P, N, x, E, b, l, c, h, p, f, g, d, y));
            }
          }
          return function (e) {
            var r,
      ...
      return (
        ...
        (N.clipExtent = function (t) {
          return arguments.length
            ? ((b = null == t ? ((E = s = a = u = null), Fd) : Ad((E = +t[0][0]), (s = +t[0][1]), (a = +t[1][0]), (u = +t[1][1]))), M())
            : null == E
            ? null
            : [
                [E, s],
    ...
    for (var r = [], i = (e / me([t[0], t[1]], [t[2], t[1]], n)) * (t[2] - t[0]), o = (e / me([t[0], t[1]], [t[0], t[3]], n)) * (t[3] - t[1]), s = 0, a = t[0]; a <= t[2]; ) {
      for (var u = 0, c = t[1]; c <= t[3]; ) {
        ...
        s % 2 == 0 && u % 2 == 0
          ...
          n.mask ? (sy(n.mask, h) && r.push(h), sy(n.mask, p) && r.push(p)) : (r.push(h), r.push(p)),
          (c += o),
          u++;
      }
      s++, (a += i);
  ...
  (ty.invert = (function (t) {
            ...
            case 'LineString':
              return (function (t, e) {
                for (var n = !1, r = 0, i = e.coordinates; r < i.length; r++) {
                  var o = i[r];
                  if ((Wr({ type: 'Point', coordinates: o }, t, { ignoreEndVertices: !0 }) && (n = !0), !Wr({ type: 'Point', coordinates: o }, t, { ignoreEndVertices: !1 }))) return !1;
                }
                return n;
              })(n, r);
            case 'MultiPoint':
            ...
            case 'LineString':
              return (function (t, e) {
                ...
                for (; r < e.coordinates.length - 1; r++) {
                  if (ye({ type: 'Point', coordinates: _s(e.coordinates[r], e.coordinates[r + 1]) }, t, { ignoreBoundary: !0 })) {
                    n = !0;
                    break;
                  }
                }
    ...
    (t.greatCircle = function (t, e, n) {
      ...
      var r = n.properties,
        i = n.npoints,
        o = n.offset;
      return (t = K(t)), (e = K(e)), (r = r || {}), (i = i || 100), (o = o || 10), new vi({ x: t[0], y: t[1] }, { x: e[0], y: e[1] }, r).Arc(i, { offset: o }).json();
    }),
    (t.helpers = O),
    (t.hexGrid = ay),
    (t.inside = ye),
    ...
    (t.standardDeviationalEllipse = function (t, e) {
      ...
      var m = Math.sqrt((2 * y) / _),
        ...
        b = _e(t, f([E])),
        w = { meanCenterCoordinates: Q(s), semiMajorAxis: m, semiMinorAxis: x, numberOfFeatures: o, angle: d, percentageWithinEllipse: (100 * G(b).length) / o };
